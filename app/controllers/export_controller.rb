class ExportController < ApplicationController
    ...
    def export_review
      ...
      csv << ["id", "marker1", "marker2", "writer", "total_address", "parcel_address", "road_address", 
              "detail_address", "price", "month", "start_year", "start_month", "how_long", "fee", "comment1", 
          ...
          @review.each do |r|
            csv << [r.id, r.marker1, r.marker2, r.writer, r.total_address, r.parcel_address, r.road_address, 
                    r.detail_address, r.price, r.month, r.start_year, r.start_month, r.how_long, r.fee, r.comment1, 
