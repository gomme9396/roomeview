        ...
        a.fn.scrollTo = function(b) {
            ...
            return "open" === b ? (this.each(function() {
                ...
                function d(c) {
                    ...
                    var p = 0,
                        q = f.parent();
                    if (!q.is("body") && q[0].scrollHeight > q[0].clientHeight && (p = q[0].scrollTop), j + i.innerWidth() > a(window).width() ? l = "right" : j - i.innerWidth() + f.innerWidth() < 0 && (l = "left"), k + i.innerHeight() > d)
                    ...
                    if ("left" === l) m = g.gutter, n = f.position().left + m;
                        ...
                        var s = f.position().left + f.outerWidth() - i.outerWidth();
                        m = -g.gutter, n = s + m
                    }
                    i.css({
                        position: "absolute",
        ...
        var b = {
            init: function(b) {
                ...
                return b = a.extend(c, b), this.each(function() {
                    ...
                    return F.hasClass("initialized") ? (a(this).trigger("carouselNext", [1e-6]), !0) : (b.full_width && (b.dist = 0, imageHeight = F.find(".carousel-item img").first().load(function() {
